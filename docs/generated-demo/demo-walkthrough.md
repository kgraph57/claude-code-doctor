...
Visual cue: Show the 104-finding proof: context tax, dead permissions, MCP bloat, and zombie automations.
...
Visual cue: Same protocol across Claude Code, Codex, Cursor, and Windows beta probes.
